...
# Dynamic File Discovery Patterns - UPDATED FOR ACTUAL FILENAMES
FILE_PATTERNS = {
    # Matches: PROCESSED_DAILY_VARS_Active_Energy_Report...
    'energy': re.compile(r'PROCESSED_DAILY_VARS.*Active_Energy|Active_Energy.*Report', re.IGNORECASE),
    
    # Matches: DataLog_02-06-2026.csv (Your Ammonia/Temperature Logs)
    'ammonia': re.compile(r'DataLog_\d{2}-\d{2}-\d{4}\.csv|Temperature_Log|Temp_Log', re.IGNORECASE),
    
    # Matches: Power consumption freon (1).xlsx
    'freon': re.compile(r'freon|Freezer_Workbook|Compressor.*Freon', re.IGNORECASE),
